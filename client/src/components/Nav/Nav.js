...
const Nav = props => (
    < header >
        ...
        <h3 style={styles.welcome} className="text-success navbar-text " >{props.state.loggedIn ? (`Welcome ${props.state.username}`) : "For Demo Purposes: Username: admin Password: password"}</h3>
    </header >
);
export default Nav;
